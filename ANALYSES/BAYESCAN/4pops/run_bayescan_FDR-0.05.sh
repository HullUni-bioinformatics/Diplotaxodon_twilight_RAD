...
man_file=/media/chrishah/STORAGE/RAD/stacks/ALL/mapping/excl_PCR_dupl/BWA-8MM/M_zebra/3-populations/Diplotaxodon_4pop/m5_mpop5_kernel_iterate_ONE_SNP_PER_TAG_EXCL_SINGLETONS_BOOTSTRAP/r_0.8-p_4/Bayescan/manfile
threads=8
pr_odds=100
FDR="0.05"
...
do 
	...
	then
		...
		cd prior_odds_$pr_odds
		echo -e "
#sourcing R functions shipping with Bayescan
