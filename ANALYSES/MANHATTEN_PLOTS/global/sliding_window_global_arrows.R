...
svg(filename = 'sliding_window_global_arrows.svg')
mat <- matrix(c(1,2,3,4,5,6,7), 7)
layout(mat, widths=c(1), heights=c(0.2,1,1,1,1,1,1))
par(mar=c(0.2, 0, 0, 0), oma = c(1,3,1,1))
library(shape)
plot(80418, 0, axes=F, cex=0.5, ylab = "", xlab = "", ylim = c(0,1), xlim = c(80418/1000,735652334/1000), yaxt = 'n', xaxt = 'n', col = 'white')
#rect(307462/1000+344511.102,0,407463/1000+344511.102,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 357462.5/1000
Arrows(x0=center+344511.102, y0=1, x1=center+344511.102, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
#rect(1709515/1000+270094.855,0,1904775/1000+270094.855,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 1807145.0/1000
Arrows(x0=center+270094.855, y0=1, x1=center+270094.855, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
#rect(324832/1000+467422.27,0,500718/1000+467422.27,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 412775.0/1000
Arrows(x0=center+467422.27, y0=1, x1=center+467422.27, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
#rect(1537985/1000+551748.404,0,1637985/1000+551748.404,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 1587985.0/1000
Arrows(x0=center+551748.404, y0=1, x1=center+551748.404, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
#rect(805/1000+696855.413,0,61669/1000+696855.413,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 31237.0/1000
Arrows(x0=center+696855.413, y0=1, x1=center+696855.413, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
#rect(75382/1000+685804.636,0,200471/1000+685804.636,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 137926.5/1000
Arrows(x0=center+685804.636, y0=1, x1=center+685804.636, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
#rect(354071/1000+654516.687,0,454071/1000+654516.687,1, col = '#16e74dff', border = '#16e74dff', lwd = '0.5')
center <- 404071.0/1000
Arrows(x0=center+654516.687, y0=1, x1=center+654516.687, y1=0, col='#16e74dff', arr.adj = 1, arr.width=0.5, arr.type='triangle')
