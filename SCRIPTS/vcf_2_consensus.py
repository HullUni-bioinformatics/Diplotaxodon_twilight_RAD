...
parser.add_argument('-c', '--coords', action='store_true', help='write base coordinates to separate file')
...
#		print sample
	...
	coords.append(record.CHROM+"\t"+str(record.POS))
...
if args.coords:
	print "writing call coordinates to '%s-coords.txt'\n" %args.out_prefix
	OUT=open(args.out_prefix+'-coords.txt','w')
	for l in coords:
		OUT.write(l+"\n")
	OUT.close()
